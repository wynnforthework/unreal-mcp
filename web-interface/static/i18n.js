...
const i18nConfig = {
    ...
    translations: {
        ...
        'zh': {
            ...
            'servers_stopped': 'MCP 服务器已停止！',
            'stopping_servers': '🛑 正在停止 MCP 服务器...',
            ...
            'failed_stop_servers': '停止 MCP 服务器失败',
            'failed_check_status': '检查服务器状态失败',
            'failed_check_detailed_status': '检查详细状态失败',
        ...
        'en': {
            ...
            'servers_stopped': 'MCP servers stopped successfully!',
            'stopping_servers': '🛑 Stopping MCP servers...',
            ...
            'failed_stop_servers': 'Failed to stop MCP servers',
            'failed_check_status': 'Failed to check server status',
            'failed_check_detailed_status': 'Failed to check detailed status',
