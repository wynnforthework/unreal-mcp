...
/**
 * Command for getting all available Blueprint actions for a class and its entire inheritance hierarchy
 * Implements the IUnrealMCPCommand interface for standardized command execution
 */
class UNREALMCP_API FGetActionsForClassHierarchyCommand : public IUnrealMCPCommand
{
public:
    /**
     * Constructor
     ...
     */
    explicit FGetActionsForClassHierarchyCommand(TSharedPtr<IBlueprintActionService> InBlueprintActionService);
