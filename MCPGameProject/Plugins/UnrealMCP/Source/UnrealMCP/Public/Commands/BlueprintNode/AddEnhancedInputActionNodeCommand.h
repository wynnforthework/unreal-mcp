...
class UNREALMCP_API FAddEnhancedInputActionNodeCommand : public IUnrealMCPCommand
{
public:
    explicit FAddEnhancedInputActionNodeCommand(IBlueprintNodeService& InBlueprintNodeService);
