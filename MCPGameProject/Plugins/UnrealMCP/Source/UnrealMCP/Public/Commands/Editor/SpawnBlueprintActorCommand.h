...
/**
 * Command for spawning Blueprint actors
 * Implements the IUnrealMCPCommand interface for standardized command execution
 */
class UNREALMCP_API FSpawnBlueprintActorCommand : public IUnrealMCPCommand
{
public:
    /**
     * Constructor
     ...
     */
    explicit FSpawnBlueprintActorCommand(IEditorService& InEditorService);
...
private:
    ...
    /**
     * Parse JSON parameters into blueprint actor spawn parameters
     * @param JsonString - JSON string containing parameters
     * @param OutParams - Parsed parameters
     * @param OutError - Error message if parsing fails
     * @return true if parsing succeeded
     */
    bool ParseParameters(const FString& JsonString, FBlueprintActorSpawnParams& OutParams, FString& OutError) const;
